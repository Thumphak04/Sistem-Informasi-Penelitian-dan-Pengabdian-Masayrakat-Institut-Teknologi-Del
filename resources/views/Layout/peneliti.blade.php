...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="@yield('halaman6')" class="nav-link">@yield("nama_halaman6")</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="@yield('halaman7')" class="nav-link">@yield("nama_halaman7")</a>
      </li>
    </ul>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            <a href="{{url('/Dashboard_Peneliti')}}"  class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/Penelitian_Peneliti')}}" class="nav-link">
              <i class=" fas fa-th"></i>
              <p>
                Penelitian
              </p>
          ...
          <li class="nav-item">
            <a href="{{url('/Pengabdian_Peneliti')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/Team_Peneliti')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/Pengumuman_Peneliti')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/Profil_peneliti')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/Artikel_Peneliti')}}" class="nav-link">

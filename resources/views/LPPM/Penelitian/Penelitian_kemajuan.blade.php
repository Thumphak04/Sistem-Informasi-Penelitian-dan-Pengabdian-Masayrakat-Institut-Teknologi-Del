...
@section('content')
<div class="card">
@section('nama_halaman','Laporan Hasil Kemajuan Penelitian')
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('/Laporan Akhir Penelitian')}}" class="nav-link">Laporan Akhir</a>
              ...
              <div class="card-header">
                <h3 class="card-title">Data Daftar Laporan  Kemajuan Penelitian</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped" >
                  ...
                  <td>1</td>
                    ...
                    <td class="project-actions text-right">
                          <a class="btn btn-primary btn-xs" href="{{url('/Detail Laporan Kemajuan')}}">

...
@section('content')
<div class="card">
@section('nama_halaman','Laporan Hasil Review Pengabdian')
<nav class="main-header navbar navbar-expand navbar-white navbar-light" style="margin-left:-40; px">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
    <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('/LaporanPengabdian')}}" class="nav-link">Laporan Reviewe</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('/Laporan Pengawasan Pengabdian')}}" class="nav-link">Laporan Pengawasan</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('/Laporan Kemajuan Pengabdian')}}" class="nav-link">Laporan Kemajuan</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('/Laporan Akhir Pengabdian')}}" class="nav-link">Laporan Akhir</a>
      </li>
      </ul>
      </nav>
              <div class="card-header">
                <h3 class="card-title">Data Daftar Laporan  Pengabdian</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
